...
public class CollectioAdapter { //extends BaseAdapter {
   /* Integer[] mValues;
    Context context;
    private List<Photo> photos;

    public CollectioAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(photo.getUrls().getRegular()).into(imageView);
